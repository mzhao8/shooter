...
#create empty tile list (list of lists(rows))
world_data = []
...
#create function for joining Background
def draw_bg():
  screen.fill(GREEN)
  width = sky_img.get_width()
  for x in range(4): #extends background by 4
    screen.blit(sky_img, ((x * width), 0))
    screen.blit(mountain_img, ((x * width) - scroll * 0.5, SCREEN_HEIGHT - mountain_img.get_height()-300))
...
while run:
  ...
  #check that the coordinates within the tile area
